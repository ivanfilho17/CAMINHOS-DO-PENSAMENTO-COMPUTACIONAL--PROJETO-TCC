        ...
        <div className="about-content">
          <section className="about-section yellow">
            ...
            <div className="about-body">
              ...
              <p>
                ...
                Reúne teoria, exemplos reais e práticos do dia a dia, vídeo, quizzes e atividades interativas.
              </p>
            </div>
          </section>
          ...
          <section className="about-section light">
            ...
            <div className="about-body">
              ...
              <ul>
                <li>Exemplos teóricos e reais do dia a dia.</li>
                <li>Atividades interativas.</li>
                <li>Exercícios de fixação (quizzes) com feedback instantânea.</li>
                <li>Feedbacks visuais.</li>
                <li>Barra de progresso para acompanhar andamento dos módulos.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="about-section neutral">
            ...
            <div className="about-body">
              ...
              <div>
                <h4>Conecte-se comigo nas redes:</h4>
              </div>
